...
const images = reactive([
    ...
    {
        id: 2,
        ImageSmallUrl: '/img/picture7.jpeg',
...
<template>
    <div class="relative m-5  flex justify-center items-center">
        <!-- image -->
        <div class="flex justify-center items-center relative overflow-hidden rounded-lg p-2 border-sm w-[70vh]">
            <img class="h-[75vh] mb-10 rounded-xl" :src="images[currentSlide].ImageSmallUrl">
        </div>
        ...
        <div class="absolute z-30 flex space-x-3  -translate-x-1/2 bottom-5 left-1/2">
            <button v-for="iml in images.length" :key="iml" 
        ...
        <!-- Slider controls -->
        <button @click="timerPause = 1; prevSlide()" id="data-carousel-prev"
        ...
        <button @click="timerPause = 1; nextSlide()" id="data-carousel-next" type="button"
